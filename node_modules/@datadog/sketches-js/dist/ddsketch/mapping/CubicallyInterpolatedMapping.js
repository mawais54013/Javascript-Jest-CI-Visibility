...
var math_float64_frexp_1 = __importDefault(require("math-float64-frexp"));
var math_float64_ldexp_1 = __importDefault(require("math-float64-ldexp"));
...
var CubicallyInterpolatedMapping = /** @class */ (function (_super) {
    ...
    CubicallyInterpolatedMapping.prototype._cubicLog2Approx = function (value) {
        var _a = math_float64_frexp_1.default(value), mantissa = _a[0], exponent = _a[1];
    ...
    CubicallyInterpolatedMapping.prototype._cubicExp2Approx = function (value) {
        ...
        return math_float64_ldexp_1.default(mantissa, exponent + 1);
    };
